...
public class Unionpay {
	...
	*/
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		//前台页面传过来的
		String merId = "777290058153521"; //商户号码
		String txnAmt = req.getParameter("txnAmt"); //交易金额,单位为分,不能带小数点
		String orderId = req.getParameter("orderId"); //商户订单号
		String txnTime = req.getParameter("txnTime"); //订单发送时间
	...
	protected String payResult(HttpServletRequest req, HttpServletResponse resp) {
